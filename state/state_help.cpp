...
void state_help::init() {
    ...
    leftPointer.setPosition(table.getPosition().x - leftPointerText.getGlobalBounds().width + 650, table.getPosition().y + 80);
    ...
    rightPointer.setPosition(table.getPosition().x  - leftPointerText.getGlobalBounds().width + 650, table.getPosition().y + 240);

    this->data->textures.load(Texture::SPACEBAR, SPACE_BAR);
    spacebar.setTexture(this->data->textures.get(Texture::SPACEBAR));
    spacebar.setPosition(table.getPosition().x  - leftPointerText.getGlobalBounds().width + 650, table.getPosition().y + 400);
    ...
    exit.setPosition(table.getPosition().x + table.getGlobalBounds().width / 2 - exit.getGlobalBounds().width / 2,
                     table.getPosition().y + 550);

    this->leftPointerText.setString("Move left");
    leftPointerText.setFont(this->data->fonts.get(Font::GAME_TITLE));
    leftPointerText.setCharacterSize(100);
    leftPointerText.setFillColor(sf::Color::Black);
    leftPointerText.setPosition(table.getPosition().x  - leftPointer.getGlobalBounds().width + 250+10, table.getPosition().y + 80+25);
    ...
    rightPointerText.setCharacterSize(100);
    rightPointerText.setFillColor(sf::Color::Black);
    rightPointerText.setPosition(table.getPosition().x - rightPointer.getGlobalBounds().width + 250+15, table.getPosition().y + 240+25);
    ...
    spacebarText.setCharacterSize(100);
    spacebarText.setFillColor(sf::Color::Black);
    spacebarText.setPosition(table.getPosition().x - leftPointer.getGlobalBounds().width + 250+10, table.getPosition().y + 400+25);
