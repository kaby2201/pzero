...
void GameOverState::init() {
    ...
    gameOverWon.setCharacterSize(60);
    ...
    highscore.setPosition(table.getPosition().x + table.getGlobalBounds().width / 2 - highscore.getGlobalBounds().width / 2,
                          table.getPosition().y + highscore.getGlobalBounds().width/2+highscore.getGlobalBounds().height);
    ...
    intScore.setScale(0.4166,0.555);
    ...
    tryAgain.setPosition(data->window.getView().getCenter().x + highscore.getGlobalBounds().width/2+tryAgain.getGlobalBounds().width/1.5,
                          (table.getPosition().y + table.getGlobalBounds().height / 2 + highscore.getGlobalBounds().width/2));
